...
<head>
    ...
    <style>
        ...
        .ch-box { background: rgba(3,7,18,0.8); border: 1px solid rgba(255,107,0,0.3); border-radius: 16px; padding: 20px; }
        .table-custom { width: 100%; border-collapse: collapse; margin-top: 15px; }
        .table-custom th, .table-custom td { padding: 14px; text-align: left; border-bottom: 1px solid rgba(255,107,0,0.15); }
    ...
    <div style="max-width: 1300px; margin: 0 auto;">
        ...
        <div class="card">
            ...
            <div class="grid-3">
                ...
                <div class="ch-box">
                    <div style="font-size: 35px; margin-bottom: 8px;">⚡</div>
                    <div style="font-family: 'Orbitron'; color: #ffd700; font-weight: 900; font-size: 16px;">12-WEEK TRANSFORMATION</div>
                    ...
                    <span style="background: rgba(255,215,0,0.2); color: #a78bfa; padding: 4px 10px; border-radius: 8px; font-size: 11px; font-weight: bold; font-family: 'Orbitron';">ACTIVE • 48 HUNTERS PARTICIPATING</span>
                </div>
            </div>
        </div>
                    ...
                    if ($lb_res && mysqli_num_rows($lb_res) > 0):
                        while($r = mysqli_fetch_assoc($lb_res)): ?>
                            <tr>
                                ...
                                <td><span style="background: rgba(255,107,0,0.15); color: var(--accent-primary); border: 1px solid var(--accent-primary); padding: 2px 10px; border-radius: 8px; font-size: 11px; font-weight: bold; font-family: 'Orbitron';"><?php echo htmlspecialchars($r['gym_rank'] ?: 'Bronze'); ?></span></td>
