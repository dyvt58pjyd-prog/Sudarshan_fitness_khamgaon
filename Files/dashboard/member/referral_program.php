...
<head>
    ...
    <style>
        ...
        .btn-copy { background: linear-gradient(135deg, var(--accent-primary), #0077ff); color: #2c1b18; border: none; padding: 12px 20px; border-radius: 12px; font-weight: 800; font-family: 'Orbitron'; cursor: pointer; }
    </style>
</head>
<body>
