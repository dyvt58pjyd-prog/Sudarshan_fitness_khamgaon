...
<head>
    ...
    <style>
    /* Cyberpunk Neon Green System Gate Background */
    body.login-page {
        background: #050A0F !important;
        position: relative;
        overflow-x: hidden;
        background-image: 
            radial-gradient(circle at 50% 20%, rgba(204, 255, 0, 0.12) 0%, transparent 55%),
            radial-gradient(circle at 50% 80%, rgba(0, 240, 255, 0.1) 0%, transparent 50%) !important;
        min-height: 100vh;
        display: flex;
        align-items: center;
    ...
    .portal-ring-background {
        ...
        box-shadow: 0 0 50px rgba(204, 255, 0, 0.12), inset 0 0 50px rgba(0, 240, 255, 0.08);
    ...
    .login-container {
        ...
        box-shadow: 0 0 60px rgba(204, 255, 0, 0.12), 0 0 0 1px rgba(255,255,255,0.02) !important;
        position: relative;
        z-index: 10;
        animation: neon-green-pulse 4s ease-in-out infinite alternate !important;
    }
    ...
    .category-tab[data-role="member"].active i { color: #CCFF00 !important; }
    ...
    .btn-primary {
        background: linear-gradient(135deg, #CCFF00, #AADD00) !important;
    ...
    .btn-primary:hover {
        ...
        box-shadow: 0 0 50px rgba(204, 255, 0, 0.6) !important;
    }
    </style>
</head>
        ...
        <div class="login-container">
            <div class="login-header login-caret">
                <div class="login-content" style="text-align: center;">
                    <div style="font-family: 'Montserrat', sans-serif; font-size: 11px; font-weight: 900; color: #CCFF00; letter-spacing: 3px; text-transform: uppercase; margin-bottom: 12px; text-shadow: 0 0 12px rgba(204,255,0,0.5);">[ SYSTEM GATE PORTAL ]</div>
					<a href="#" class="logo">
						<img src="<?php echo htmlspecialchars($logo_path); ?>" alt="Gym Logo" style="filter: drop-shadow(0 0 20px rgba(204,255,0,0.4)); max-height: 95px; width: auto;" />
                    </a>
