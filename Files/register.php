        ...
        <div class="register-container">
            ...
            <?php if (!empty($success_message)): ?>
                <div class="alert alert-success" style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 12px; padding: 20px; color: #ffffff; margin-bottom: 35px;">
                    ...
                    <p style="margin: 0; font-size: 13px; color: var(--text-muted);">Please note down your Member ID. Your password is what you chose during registration. Staff will verify your payment screenshot and activate your account shortly.</p>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group-premium">
                                ...
                                <input type="password" name="password" class="form-control-premium" placeholder="Choose a password" required>
                            </div>
                            <div class="form-group-premium">
                                <label>Gender</label>
