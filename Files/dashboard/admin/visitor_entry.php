            ...
            <div class="portal-card" style="max-width: 800px; margin: 0 auto;">
                <form action="submit_visitor.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label style="color: var(--text-main); font-weight: 600;"><i class="entypo-camera"></i> Live Photo Capture *</label>
                            <div style="background: rgba(0,0,0,0.2); padding: 20px; border-radius: 12px; border: 1px solid var(--glass-border); text-align: center;">
                                ...
                                <input type="hidden" name="captured_photo" id="captured_photo" value="" required>
                                ...
                                <div style="font-size: 11px; color: var(--text-muted); margin-top: 10px;">
                                    * Capturing a live photo of the visitor is mandatory for security and identification.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            if (!capturedInput.value) {
                e.preventDefault();
                alert("Please capture a live photo before saving the visitor record.");
            }
        });
    </script>
</body>
