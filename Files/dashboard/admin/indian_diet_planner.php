    ...
    <div style="max-width: 1300px; margin: 0 auto;">
        ...
        <div class="card">
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                <button style="background: var(--accent-primary); color: #2c1b18; border: none; padding: 10px 20px; border-radius: 12px; font-weight: 800; font-family: 'Orbitron'; cursor: pointer;">🌱 VEGETARIAN (PANEER/DAL)</button>
