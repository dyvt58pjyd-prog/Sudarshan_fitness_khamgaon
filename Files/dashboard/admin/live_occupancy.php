...
<body>
    ...
    <div style="max-width: 1100px; margin: 0 auto;">
        ...
        <div class="card" style="text-align: center; padding: 40px;">
            ...
            <div style="font-size: 16px; color: var(--text-main); font-family: 'Orbitron'; font-weight: 800; margin-bottom: 25px;"><?php echo $capacity_pct; ?>% GYM CAPACITY OCCUPIED</div>
            ...
            <div style="width: 100%; max-width: 600px; margin: 0 auto; background: rgba(255,255,255,0.05); height: 16px; border-radius: 10px; overflow: hidden; border: 1px solid var(--glass-border); box-shadow: inset 0 2px 5px rgba(0,0,0,0.5);">
                <div style="width: <?php echo $capacity_pct; ?>%; height: 100%; background: linear-gradient(90deg, var(--accent-primary), #ffd700); border-radius: 10px; box-shadow: 0 0 20px var(--accent-primary);"></div>
            </div>
        </div>
    </div>
</body>
