...
echo "=== SENDING TEST REGISTRATION EMAIL TO: {$target_email} ===\n";
...
if ($result) {
    ...
    echo "ATTEMPTING DIRECT SMTP DISPATCH...\n";
    $subject = "📷 Test Registration Email - Sudarshan Fitness";
    $body = "<h2>Test Email Confirmation</h2><p>Hello Anurag, this is a test email confirmation from Sudarshan Fitness Application System.</p><p><a href='https://sudarshanfitness.de/Files/download_app.php' style='padding: 12px 20px; background: #ff6b00; color: white; border-radius: 8px; text-decoration: none;'>Install Application</a></p>";
