...
$_POST['u_name'] = 'Test Prebook';
$_POST['gender'] = 'Male';
$_POST['mobile'] = '9999999999';
$_POST['email'] = 'prebook@example.com';
...
$content = file_get_contents('prebook.php');
$content = str_replace('move_uploaded_file', 'rename', $content);
file_put_contents('prebook_test.php', $content);

ob_start();
include 'prebook_test.php';
$output = ob_get_clean();
