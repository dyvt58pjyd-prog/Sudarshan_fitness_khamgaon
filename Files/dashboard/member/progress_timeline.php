...
<head>
    ...
    <style>
        ...
        .timeline-box { background: rgba(3,7,18,0.8); border: 1px solid rgba(255,107,0,0.3); border-radius: 16px; padding: 15px; text-align: center; }
        ...
        .btn-upload { background: linear-gradient(135deg, var(--accent-primary), #0077ff); color: #2c1b18; border: none; padding: 10px 18px; border-radius: 12px; font-weight: 800; font-family: 'Orbitron'; cursor: pointer; margin-top: 10px; }
    </style>
</head>
<body>
    ...
    <div style="max-width: 1200px; margin: 0 auto;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
            ...
            <a href="index.php" style="background: rgba(255,107,0,0.15); color: var(--accent-primary); border: 1px solid var(--glass-border); padding: 8px 18px; border-radius: 12px; text-decoration: none; font-family: 'Orbitron'; font-weight: 800; font-size: 12px;">← RETURN TO DASHBOARD</a>
        </div>
        ...
        <div class="card">
            ...
            <div style="display: flex; gap: 20px; flex-wrap: wrap; margin-top: 15px;">
                <div style="flex: 1; min-width: 150px; background: rgba(3,7,18,0.8); border: 1px solid rgba(255,107,0,0.3); padding: 15px; border-radius: 14px; text-align: center;">
