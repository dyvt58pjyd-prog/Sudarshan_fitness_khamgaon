                ...
                <tr class="total-row">
                    <td colspan="2" style="border: none; padding-top: 15px; vertical-align: top; text-align: left;">
                        ...
                        <div class="upi-pay-card" style="display: inline-flex; align-items: center; gap: 15px; background: #fafafa; border: 1px solid #f0f0f0; padding: 12px; border-radius: 12px; max-width: 320px; text-align: left; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important;">
                            ...
                            $upi_url = "upi://pay?pa=" . urlencode($clean_upi_id) . "&pn=" . urlencode($gym['gym_name']) . "&am=" . urlencode($clean_amount) . "&tn=" . urlencode("Invoice-" . $row['et_id']) . "&cu=INR";
                            ...
                            <div>
                                ...
                                <span style="display: block; font-size: 13px; font-weight: 600; color: var(--primary); margin: 2px 0;">₹<?php echo $total_paid; ?></span>
                                <span style="display: block; font-size: 9.5px; color: var(--text-light); word-break: break-all; font-family: monospace;"><?php echo htmlspecialchars($upi_id); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </td>
