...
<body class="page-body login-page login-form-fall" style="opacity: 0; transition: opacity 0.8s ease;">
    ...
    <div id="cinematic-splash" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: 9999999; background: #000; display: flex; flex-direction: column; justify-content: center; align-items: center; transition: opacity 1s ease-in-out, visibility 1s; overflow: hidden;">
        <video autoplay muted loop playsinline style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; opacity: 0.4; filter: blur(2px);">
            <source src="https://assets.mixkit.co/videos/preview/mixkit-man-training-with-battle-ropes-in-a-gym-23136-large.mp4" type="video/mp4">
        </video>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (sessionStorage.getItem('splashShown')) {
                ...
                // Show it, then fade out after 3.5 seconds
                setTimeout(function() {
