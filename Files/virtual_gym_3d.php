        ...
        <div class="panel">
            ...
            <div class="zone-card active" onclick="switchGymZone('weights', this)">
                ...
                <div>
                    ...
                    <p style="color:var(--text-muted); font-size:11px;">Dumbbells &amp; Vighnaharta Barbells</p>
                </div>
            </div>
            ...
            <div class="zone-card" onclick="switchGymZone('shop', this)">
                ...
                <div>
                    ...
                    <p style="color:var(--text-muted); font-size:11px;">Elixirs &amp; Vighnaharta Gear</p>
                </div>
            </div>
    ...
    <script>
        ...
        function switchGymZone(zone, cardEl) {
            ...
            if (zone === 'weights') {
                ...
                title.textContent = 'Dumbbells & Vighnaharta Barbell Floor';
                ...
                title.textContent = 'Vighnaharta Nutrition Item Shop';
