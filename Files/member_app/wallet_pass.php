...
<body>
    ...
    <div style="width: 100%; max-width: 380px; margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center;">
        <a href="dashboard.php" style="color: #94a3b8; text-decoration: none; font-size: 13px; font-weight: 700;">← Back to Dashboard</a>
    ...
    <div style="width: 100%; max-width: 380px; margin-top: 18px; display: grid; gap: 9px;">
        ...
        <a href="dashboard.php" class="btn-action" style="background: rgba(255,255,255,0.05); color: #94a3b8; border: 1px solid rgba(255,255,255,0.1);">
            Return to Dashboard
        </a>
    </div>
