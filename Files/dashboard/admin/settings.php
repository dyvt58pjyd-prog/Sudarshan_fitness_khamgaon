            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px;">
                ...
                <div>
                    ...
                    <div style="display: flex; gap: 10px; align-items: center; margin-top: 5px;">
                        ...
                        <button type="button" onclick="SFThemeEngine.setAccentColor('#ffd700')" style="width: 36px; height: 36px; border-radius: 50%; background: #ffd700; border: 2px solid #fff; cursor: pointer;" title="Shadow Purple"></button>
