...
<head>
    ...
    <style>
        ...
        .table-custom th, .table-custom td { padding: 12px; text-align: left; border-bottom: 1px solid rgba(255,107,0,0.15); font-size: 13px; }
            ...
            <table class="table-custom">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>10-Jan-2026</td>
                        <td>10-Jul-2026</td>
                        <td><span class="status-badge" style="background: rgba(255,107,0,0.2); color: #ff6b00; border: 1px solid #ff6b00;">🔴 UNDER REPAIR</span></td>
                    </tr>
                </tbody>
            </table>
        </div>
