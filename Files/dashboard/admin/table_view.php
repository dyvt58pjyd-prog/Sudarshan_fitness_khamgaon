   ...
   <link rel="stylesheet" href="../../css/style.css"  id="style-resource-5">
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="member-tabs-container">
			...
			<a href="?status=1year" class="tab-btn <?php echo $status === '1year' ? 'active-tab' : ''; ?>" style="border-color: rgba(255, 107, 0, 0.4);">
			...
			<thead>
				...
				foreach ($members_to_show as $mem) {
					...
					if (stripos($p_name_display, 'year') !== false || stripos($p_name_display, '12') !== false) {
						$p_badge = "<span style='color: #ff6b00; font-weight: 800;'>👑 $p_name_display</span>";
