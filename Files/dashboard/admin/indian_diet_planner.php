...
<head>
    ...
    <style>
        ...
        .meal-box { background: rgba(3,7,18,0.8); border: 1px solid rgba(255,107,0,0.3); border-radius: 16px; padding: 20px; margin-bottom: 15px; }
...
<body>
    ...
    <div style="max-width: 1300px; margin: 0 auto;">
        ...
        <!-- Category Selector -->
        <div class="card">
            <h3 style="font-family: 'Orbitron'; color: var(--text-main); margin-top: 0;">🥗 Select Diet Preference</h3>
            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                <button style="background: var(--accent-primary); color: #ffffff; border: none; padding: 10px 20px; border-radius: 12px; font-weight: 800; font-family: 'Orbitron'; cursor: pointer;">🌱 VEGETARIAN (PANEER/DAL)</button>
                <button style="background: rgba(255,107,0,0.15); color: var(--accent-primary); border: 1px solid var(--glass-border); padding: 10px 20px; border-radius: 12px; font-weight: 800; font-family: 'Orbitron'; cursor: pointer;">🍗 HIGH PROTEIN NON-VEG</button>
                <button style="background: rgba(255,107,0,0.15); color: var(--accent-primary); border: 1px solid var(--glass-border); padding: 10px 20px; border-radius: 12px; font-weight: 800; font-family: 'Orbitron'; cursor: pointer;">🌿 JAIN NUTRITION</button>
                <button style="background: rgba(255,107,0,0.15); color: var(--accent-primary); border: 1px solid var(--glass-border); padding: 10px 20px; border-radius: 12px; font-weight: 800; font-family: 'Orbitron'; cursor: pointer;">🌾 VEGAN MEAL PLAN</button>
            </div>
        </div>
        ...
        <div class="grid-2">
            <div class="card">
                <h3 style="font-family: 'Orbitron'; color: var(--text-main); margin-top: 0;">🌅 Morning &amp; Breakfast Options</h3>
                ...
                <div class="meal-box">
                    ...
                    <p style="font-size: 13px; color: var(--text-main); margin-top: 8px;">3 Whole Eggs + 1 Wheat Paratha + 50g Oats in Almond Milk &amp; Nuts.</p>
                ...
                <div class="meal-box">
                    ...
                    <p style="font-size: 13px; color: var(--text-main); margin-top: 8px;">1 Bowl Vegetable Poha + 100g Sautéed Paneer Cubes + 1 Glass Buttermilk (Chaas).</p>
            ...
            <div class="card">
                <h3 style="font-family: 'Orbitron'; color: var(--text-main); margin-top: 0;">🍛 Lunch &amp; Dinner Options</h3>
                ...
                <div class="meal-box">
                    ...
                    <p style="font-size: 13px; color: var(--text-main); margin-top: 8px;">200g Tandoori Chicken Breast + 150g Steamed Rice + Cucumber Tomato Salad.</p>
                ...
                <div class="meal-box">
                    ...
                    <p style="font-size: 13px; color: var(--text-main); margin-top: 8px;">1 Large Bowl Moong/Toor Dal + 120g Matar Paneer + 2 Multigrain Roti.</p>
