...
if (mysqli_query($con, $q1)) {
    ...
    echo "Failed to update Gym Email: " . mysqli_error($con) . "<br>";
}
...
if (mysqli_query($con, $q2)) {
    echo "SMTP Settings updated successfully for $smtp_username.<br>";
} else {
    echo "Failed to update SMTP Settings: " . mysqli_error($con) . "<br>";
}
echo "DONE.";
?>
