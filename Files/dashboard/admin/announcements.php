...
<body>
    ...
    <div style="max-width: 1100px; margin: 0 auto;">
        ...
        <?php if ($msg): ?>
            <div style="background: rgba(255,107,0,0.15); border: 1px solid var(--accent-primary); color: var(--accent-primary); padding: 14px; border-radius: 12px; margin-bottom: 20px; font-weight: bold;">
