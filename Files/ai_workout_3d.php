...
$fitness_goal = 'Vighnaharta Strength Awakening';
...
<head>
    ...
    <style>
        :root {
            ...
            --system-cyan: #00f0ff;
            --system-blue: #0077ff;
            --monarch-purple: #ffd700;
            --monarch-glow: rgba(255, 215, 0, 0.4);
            --quest-gold: #ffb703;
            --text-main: #f8fafc;
            --text-muted: #64748b;
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Outfit', sans-serif; }
        ...
        body {
            ...
            overflow-x: hidden;
            background-image: 
                radial-gradient(circle at 50% 20%, rgba(255, 215, 0, 0.15) 0%, transparent 60%),
        ...
        .status-window {
            background: linear-gradient(135deg, rgba(0, 240, 255, 0.1) 0%, rgba(255, 215, 0, 0.15) 100%);
        ...
        /* Stage Container */
        .viewport-container {
            background: radial-gradient(circle at 50% 40%, #0b1329 0%, #2c1b18 100%);
        ...
        .voice-btn {
            background: linear-gradient(135deg, #ffd700, #480094);
            color: #fff;
            border: none;
            padding: 10px 18px;
            border-radius: 14px;
...
<body>
    ...
    <!-- Shree Ganesha System Background Particles Canvas -->
    ...
    <div class="app-layout">
        ...
        <div class="panel">
            ...
            <div class="tip-card" style="margin-top: 15px; background: rgba(255, 215, 0, 0.15); border-color: var(--monarch-purple);">
    ...
    <script>
        ...
        // Shree Ganesha System Background Particles Engine
