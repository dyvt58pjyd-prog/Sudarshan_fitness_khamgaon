...
<body>
    ...
    <div style="max-width: 1200px; margin: 0 auto;">
        ...
        <div class="card">
            <h3 style="font-family: 'Orbitron'; color: var(--text-main); margin-top: 0;">🍏 Standard High-Protein Muscle Building Diet Template</h3>
            
            <div class="meal-box">
                <div class="meal-title">🍳 MEAL 1: BREAKFAST (8:00 AM)</div>
                <div style="font-size: 13px; color: var(--text-main); line-height: 1.5;">4 Whole Eggs / Tofu Scramble + 100g Oats with Almond Milk &amp; Banana + 1 Scoop Whey Protein.</div>
            ...
            <div class="meal-box">
                ...
                <div style="font-size: 13px; color: var(--text-main); line-height: 1.5;">200g Grilled Chicken Breast / Paneer + 150g Brown Rice + Mixed Green Salad &amp; Olive Oil.</div>
            ...
            <div class="meal-box">
                ...
                <div style="font-size: 13px; color: var(--text-main); line-height: 1.5;">2 Whole Wheat Toast + 2 tbsp Peanut Butter + 1 Apple / Pre-Workout Matrix drink.</div>
            ...
            <div class="meal-box">
                ...
                <div style="font-size: 13px; color: var(--text-main); line-height: 1.5;">180g Fish / Paneer Tikka + Steamed Broccoli, Carrots &amp; Quinoa or 2 Chapati.</div>
